...
function DirButton({ direction, rotation, variant = 'cardinal', onPress, onRelease }) {
    ...
    >
      ...
      >
        <DirButton direction="nw" variant="diagonal" rotation={-45}
          onPress={() => fire('nw', true)} onRelease={() => fire('nw', false)} />
        <DirButton direction="n" rotation={0}
          onPress={() => fire('n', true)} onRelease={() => fire('n', false)} />
        <DirButton direction="ne" variant="diagonal" rotation={45}
          onPress={() => fire('ne', true)} onRelease={() => fire('ne', false)} />

        <DirButton direction="w" rotation={-90}
          onPress={() => fire('w', true)} onRelease={() => fire('w', false)} />
        ...
        <DirButton direction="e" rotation={90}
          onPress={() => fire('e', true)} onRelease={() => fire('e', false)} />

        <DirButton direction="sw" variant="diagonal" rotation={-135}
          onPress={() => fire('sw', true)} onRelease={() => fire('sw', false)} />
        <DirButton direction="s" rotation={180}
          onPress={() => fire('s', true)} onRelease={() => fire('s', false)} />
        <DirButton direction="se" variant="diagonal" rotation={135}
          onPress={() => fire('se', true)} onRelease={() => fire('se', false)} />
      </div>
    </div>
  )
}
