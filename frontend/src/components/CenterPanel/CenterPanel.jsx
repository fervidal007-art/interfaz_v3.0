    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <div className="rounded-2xl border border-border/70 bg-card/80 p-4 shadow-sm">
          ...
          <p className="mt-2 text-lg font-semibold text-foreground">Manual</p>
        ...
        <div className="rounded-2xl border border-border/70 bg-card/80 p-4 shadow-sm">
          ...
          <p className="mt-2 text-lg font-semibold text-foreground">{sequenceCount}</p>
...
export function CenterPanel(props) {
  ...
  return (
    <section className="w-full max-w-[760px] rounded-[2rem] border border-border/70 bg-card/75 p-4 shadow-[0_16px_36px_rgba(18,42,94,0.08)] backdrop-blur-[2px] sm:p-5">
      <div className="space-y-4">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-primary/60">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Alterna entre control manual y composicion de secuencias.
            </p>
          </div>
